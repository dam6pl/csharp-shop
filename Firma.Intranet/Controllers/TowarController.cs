...
namespace Firma.Intranet.Controllers
{
    public class TowarController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdTowaru,Kod,Nazwa,Cena,ZdjecieUrl,Opis,IdRodzaju")] Towar towar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTowaru,Kod,Nazwa,Cena,ZdjecieUrl,Opis,IdRodzaju")] Towar towar)
        {
